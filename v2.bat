...
call :ColorText 66 "-"
call :ColorText 0F "]"
echo  Do you want to clear the Shadow Copies? (y/n)
choice /c yn /n
if %errorlevel%==1 goto ShadowCopies
if %errorlevel%==2 goto Quest6
...
call :ColorText 66 "-"
call :ColorText 0F "]"
echo  Do you want to clear the DNS Cache tracks? (y/n)
choice /c yn /n
if %errorlevel%==1 goto FlushDNS
if %errorlevel%==2 goto Quest7
...
call :ColorText 66 "-"
call :ColorText 0F "]"
echo  Do you want to clean up the Event Log? (y/n)
choice /c yn /n
if %errorlevel%==1 goto EventLog
if %errorlevel%==2 goto Quest8
...
call :ColorText AA "-"
call :ColorText 0F "]"
echo  MsMPeng has been sucessfully crashed.
timeout /t 3 >nul
cls
goto Quest4
...
call :ColorText AA "-"
call :ColorText 0F "]"
echo  Shadow Copies has been sucessfully cleared.
timeout /t 3 >nul
cls 
goto Quest6
...
call :ColorText AA "-"
call :ColorText 0F "]"
echo  DNS Cache tracks has been sucessfully cleared.
timeout /t 3 >nul
cls
goto Quest7
...
wmic nteventlog where filename='logfilename' cleareventlog >nul
echo.
call :ColorText 0F "["
call :ColorText AA "-"
call :ColorText 0F "]"
echo  Event Log has been sucessfully cleared.
timeout /t 3 >nul
cls
goto Quest8
